...
#define PROFILE_PAYLOAD_LEN 31 // +1 byte CRC8 = 32 bytes
...
#define CAPTION_MIN_POS_X 8
#define CAPTION_MAX_POS_X 16
#define CAPTION_MIN_POS_Y 32
#define CAPTION_MAX_POS_Y 48

#define CAPTION_MAX_LEN 32
